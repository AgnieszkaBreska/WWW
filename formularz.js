...
function MaxiRozmiar(dlugosc) {
    ...
    if (document.Form1.pesel.value.length > dlugosc) {
        document.Form1.pesel.value = wartoscOpis;
    } else {
        wartoscOpis = document.Form1.pesel.value;
    }
...
function randomName() {
    ...
    imie = ['Anna', 'Jakub', 'Jan', 'Piotr', 'Szymon', 'Kasia', 'Joanna', 'Zuzanna', 'Tomek', 'Ola'];
    return imie[liczba];
}
function randomSurname() {
    ...
    var liczba, nazwisko;
    liczba = Math.floor(Math.random() * 10);
    nazwisko = ['Nowak', 'Wieczorek', 'Mazur', 'Krawczyk', 'Smok', 'Smith', 'Wanat', 'Kwiatek', 'Bez', 'Maj'];
